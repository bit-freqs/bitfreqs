...
module.exports = {
  preload: function (game) {
    ...
    game.load.spritesheet('waves', 'assets/wave-sprite-attempt.png', 1138.33, 150, 5)
  },
  ...
  createWaves: function (game) {
    ...
    waves.push(game.add.sprite(1138.33 * scale, gameHeight - (150 * scale), 'waves'))
    // waves.push(game.add.sprite(892.4 * scale, gameHeight - (150 * scale), 'waves'))

    for (var wave of waves) {
      wave.animations.add('animateWaves', [0, 1, 2, 3 ,4, 5], 5, true)
